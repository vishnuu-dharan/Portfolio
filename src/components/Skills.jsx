        ...
        <div className="skills-categories">
          ...
          <div className="skill-category">
            ...
            <div className="skill-badges">
              ...
              <div className="skill-badge">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="12" cy="18" r="3"/><line x1="8.5" y1="7.5" x2="10.5" y2="15.5"/><line x1="15.5" y1="7.5" x2="13.5" y2="15.5"/></svg>
                LLM Orchestration
              </div>
              <div className="skill-badge">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="5" r="3"/><circle cx="5" cy="19" r="3"/><circle cx="19" cy="19" r="3"/><line x1="10" y1="7" x2="7" y2="17"/><line x1="14" y1="7" x2="17" y2="17"/></svg>
                Multi-Agent Systems
              </div>
              <div className="skill-badge">
          ...
          <div className="skill-category">
            ...
            <div className="skill-badges">
              ...
              <div className="skill-badge">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/><line x1="14" y1="4" x2="10" y2="20"/></svg>
                RESTful APIs
              </div>
              <div className="skill-badge">
          ...
          <div className="skill-category">
            ...
            <div className="skill-badges">
              ...
              <div className="skill-badge">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="6" cy="19" r="3"/><circle cx="18" cy="5" r="3"/><path d="M12 19h4.5a3.5 3.5 0 0 0 0-7h-8a3.5 3.5 0 0 1 0-7H15"/><polyline points="6 12 6 16 6 12"/></svg>
                React Router
              </div>
            </div>
          </div>
          ...
          <div className="skill-category">
            ...
            <div className="skill-badges">
              ...
              <div className="skill-badge">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 14.93c-2.3.17-4.2-1.4-4.5-3.68-.28-2.28 1.2-4.3 3.48-4.58 2.28-.28 4.3 1.2 4.58 3.48.2 1.63-.6 3.16-1.96 3.98l.4 1.8-2-.5z"/></svg>
                PostgreSQL
              </div>
            </div>
          </div>
